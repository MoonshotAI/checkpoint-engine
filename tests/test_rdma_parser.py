...
class TestNCCLIBHCAParser:
    ...
    @pytest.fixture
    def mock_available_devices(self):
    ...
    def parser_with_mock_devices(self, mock_available_devices):
        ...
        with patch.object(NCCLIBHCAParser, '_ibv_get_device_list', return_value=mock_available_devices):
    ...
    def test_detect_ibv_list(self):
        ...
        parser = NCCLIBHCAParser()
        real_ibv_list = os.listdir('/sys/class/infiniband') if os.path.exists('/sys/class/infiniband') else []
        if real_ibv_list:
            assert parser.available_devices == real_ibv_list

    def test_init_with_mock_devices(self, mock_available_devices):
    ...
    def test_parse_empty_string_returns_all_devices(self, parser_with_mock_devices):
    ...
    def test_parse_whitespace_only_returns_all_devices(self, parser_with_mock_devices):
        """Test whitespace-only string returns all devices"""
        result = parser_with_mock_devices.parse("   \t\n  ")
        assert result == parser_with_mock_devices.available_devices

    def test_parse_none_string_returns_all_devices(self, parser_with_mock_devices):
    ...
    def test_parse_prefix_match_single_device(self, parser_with_mock_devices):
        """Test prefix matching for single device"""
        result = parser_with_mock_devices.parse("mlx5_0")
        assert result == ['mlx5_0']

    def test_parse_prefix_match_multiple_devices(self, parser_with_mock_devices):
    ...
    def test_parse_exact_match_single_device(self, parser_with_mock_devices):
        """Test exact matching for single device"""
        result = parser_with_mock_devices.parse("=mlx5_0")
        assert result == ['mlx5_0']

    def test_parse_exact_match_multiple_devices(self, parser_with_mock_devices):
        """Test exact matching for multiple devices"""
        result = parser_with_mock_devices.parse("=mlx5_0,mlx5_1")
        assert result == ['mlx5_0', 'mlx5_1']

    def test_parse_exact_match_with_nonexistent_device(self, parser_with_mock_devices):
        ...
        with patch('checkpoint_engine.rdma_parser.logger') as mock_logger:
            ...
            assert result == []
            mock_logger.warning.assert_called_once_with("Device 'mlx5_100' not found in available devices.")

    def test_parse_exclude_single_device(self, parser_with_mock_devices):
        """Test excluding single device"""
        result = parser_with_mock_devices.parse("^mlx5_0")
        expected = [dev for dev in parser_with_mock_devices.available_devices if dev != 'mlx5_0']
        assert result == expected

    def test_parse_exclude_multiple_devices(self, parser_with_mock_devices):
        """Test excluding multiple devices"""
        result = parser_with_mock_devices.parse("^mlx5_0,mlx5_1")
        expected = [dev for dev in parser_with_mock_devices.available_devices
                   if dev not in ['mlx5_0', 'mlx5_1']]
        assert result == expected

    def test_parse_exclude_with_prefix_match(self, parser_with_mock_devices):
        """Test exclusion with prefix matching"""
        result = parser_with_mock_devices.parse("^mlx5")
        expected = ['mlx4_0', 'mlx4_1', 'roce_0', 'roce_1']
        assert result == expected

    def test_parse_exclude_with_exact_match(self, parser_with_mock_devices):
    ...
    def test_parse_exclude_nonexistent_device(self, parser_with_mock_devices):
    ...
    def test_parse_with_port_specification(self, parser_with_mock_devices):
        """Test parsing with port specification"""
        result = parser_with_mock_devices.parse("mlx5_0:1,mlx5_1:2")
        expected = ['mlx5_0:1', 'mlx5_1:2']
        assert result == expected

    def test_parse_mixed_with_and_without_ports(self, parser_with_mock_devices):
    ...
    def test_parse_max_hcas_limit(self, parser_with_mock_devices):
    ...
    def test_parse_complex_combination(self, parser_with_mock_devices):
    ...
    def test_parse_multiple_prefix_operators(self, parser_with_mock_devices):
        """Test multiple prefix operators"""
        result = parser_with_mock_devices.parse("^=mlx5_0")
        expected = [dev for dev in parser_with_mock_devices.available_devices if dev != 'mlx5_0']
        assert result == expected

    def test_parse_edge_case_empty_after_operators(self, parser_with_mock_devices):
    ...
    def test_parse_edge_case_only_operators(self, parser_with_mock_devices):
    ...
    def test_parse_with_spaces_in_input(self, parser_with_mock_devices):
        """Test parsing with spaces in input"""
        result = parser_with_mock_devices.parse(" mlx5_0 , mlx5_1 ")
        assert result == ['mlx5_0', 'mlx5_1']

    def test_parse_empty_device_spec(self, parser_with_mock_devices):
    ...
    def test_ibv_get_device_list_real_implementation_mocked(self):
        ...
        with patch.object(NCCLIBHCAParser, '_ibv_get_device_list', return_value=['mlx5_0', 'mlx5_1']):
            parser = NCCLIBHCAParser()
    ...
    def test_resolve_device_specs_no_match(self, parser_with_mock_devices):
        ...
        with patch('checkpoint_engine.rdma_parser.logger') as mock_logger:
            ...
            assert result == []
            mock_logger.warning.assert_called_once_with("No devices match the prefix 'nonexistent'.")

    def test_resolve_device_specs_exact_match_not_found(self, parser_with_mock_devices):
        ...
        with patch('checkpoint_engine.rdma_parser.logger') as mock_logger:
            ...
            assert result == []
            mock_logger.warning.assert_called_once_with("Device 'nonexistent' not found in available devices.")